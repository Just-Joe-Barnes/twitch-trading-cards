...
async function acceptOffer(listingId, offerId, userId, session) {
    ...
    console.log('[Accept Offer Service] Archiving the sold listing.');
    listing.status = 'sold';
    listing.offers = [offer]; // ✅ CHANGED: Now keeps only the accepted offer for the archive.
    await listing.save({session});
    console.log('[Accept Offer Service] Listing archived.');
...
async function finalizeOfferAcceptance({seller, buyer, listing, offer}) {
    ...
    logAudit('Market Offer Accepted', {
